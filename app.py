    ...
    with st.spinner('Carregando dados...'):
        ...
        if resultado[0] is None:
            ...
            with tab1:
                ...
                # Gráfico de Valor por Classificação (Bar Chart Horizontal) - CRÍTICO
                with col_chart2:
                    ...
                    fig.update_traces(
                        ...
                        textfont=dict(color='black'), # Cor do texto preta
                        marker_color='#28a745' # Cor da barra (verde, exemplo)
                    )
                    fig.update_layout(
                        xaxis_title='Valor (R$)',
            ...
            with tab2:
                ...
                st.dataframe(
                    ...
                    hide_index=True # Esconde o índice padrão do DataFrame
                )
            ...
            with tab4:
                ...
                df_display = df_display.reset_index(drop=True) # Remove o índice anterior
