...
def tela_login():
    ...
    with col2:
        ...
        st.write("")
        st.markdown("---")
        st.markdown("<p style='text-align: center; color: #95a5a6; font-size: 12px;'>Dashboard Baile 2025 v4.4 - Protegido por Senha</p>", unsafe_allow_html=True)
...
def gerar_pdf_relatorio(df_filtrado, resumo_exec):
    ...
    resumo_table.setStyle(TableStyle([('BACKGROUND', (0, 0), (-1, 0), colors.HexColor('#2c3e50')), ('TEXTCOLOR', (0, 0), (-1, 0), colors.whitesmoke), ('ALIGN', (0, 0), (-1, -1), 'CENTER'), ('FONTNAME', (0, 0), (-1, 0), 'Helvetica-Bold'), ('FONTSIZE', (0, 0), (-1, 0), 11), ('BOTTOMPADDING', (0, 0), (-1, 0), 12), ('BACKGROUND', (0, 1), (-1, -1), colors.beige), ('GRID', (0, 0), (-1, -1), 1, colors.black), ('ROWBACKGROUNDS', (0, 1), (-1, -1), [colors.white, colors.HexColor('#f0f0f0')])]))
    elements.append(resumo_table)
    elements.append(Spacer(1, 0.3*inch))
    elements.append(Paragraph('📋 DADOS BRUTOS FILTRADOS', styles['Heading2']))
    elements.append(Spacer(1, 0.1*inch))
    if not df_filtrado.empty:
        ...
        table_bruta.setStyle(TableStyle([('BACKGROUND', (0, 0), (-1, 0), colors.HexColor('#2c3e50')), ('TEXTCOLOR', (0, 0), (-1, 0), colors.whitesmoke), ('ALIGN', (0, 0), (-1, -1), 'CENTER'), ('ALIGN', (1, 1), (1, -1), 'LEFT'), ('ALIGN', (2, 1), (2, -1), 'LEFT'), ('FONTNAME', (0, 0), (-1, 0), 'Helvetica-Bold'), ('FONTSIZE', (0, 0), (-1, 0), 8), ('FONTSIZE', (0, 1), (-1, -1), 6), ('BOTTOMPADDING', (0, 0), (-1, 0), 6), ('GRID', (0, 0), (-1, -1), 1, colors.black), ('ROWBACKGROUNDS', (0, 1), (-1, -1), [colors.white, colors.HexColor('#ecf0f1')]), ('VALIGN', (0, 0), (-1, -1), 'MIDDLE')]))
    ...
    elements.append(Paragraph('Relatório gerado automaticamente - Dashboard Baile 2025 v4.4', footer_style))
    doc.build(elements)
    buffer.seek(0)
    return buffer
...
if not st.session_state.autenticado:
    ...
    st.sidebar.markdown('---')
    st.sidebar.info(f'Dashboard Baile 2025 v4.4\n\n👤 Usuário: {st.session_state.usuario_atual}')
